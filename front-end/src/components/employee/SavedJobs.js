...
const SavedJobs = () => {
    ...
    const getRequestParams = (searchTitle, searchCompanyName, filterProfession, filterArea, filterForm, filterRank,employeeid, page, pageSize) => {
        let params = {};
    ...
    const retrieveJobs = () => {
        const params = getRequestParams(searchTitle, searchCompanyName, filterProfession, filterArea, filterForm, filterRank,id, page, pageSize);
    ...
    return (
        <div>
            ...
            <div className="JobLists">
                    ...
                    <div className='search-content flex-grow-1'>
                        ...
                        {!hidden ? <div className='advance-search'>
                            ...
                            <div className="table-info row row-cols-2 row-cols-lg-2">
                                {/* <div className="form-outline mb-4">
                  <label >Salary</label>
                  <input className="form-control" list="salarylist" id="salarydatalist" placeholder="Mức lương" ></input>
                  <datalist id="salarylist">
                    ...
                    <option value="Thoả thuận" />
                                ...
                                <div className="form-outline mb-4">
                                    ...
                                    <input className="form-control filter-profession" list="datalistOptions1" id="exampleDataList1" placeholder="Tất cả ngành nghề" onChange={handleProfessionChange}></input>
                                ...
                                <div className="form-outline mb-4">
                                    ...
                                    <input className="form-control" list="formlist" id="formdatalist" placeholder="Hình thức làm việc" onChange={handleFormChange}></input>
                                ...
                                <div className="form-outline mb-4">
                                    <label >Rank</label>
                                    <input className="form-control" list="ranklist" id="rankdatalist" placeholder="Cấp bậc" onChange={handleRankChange}></input>
                                ...
                                <div className="form-outline mb-4">
                                    <label >Area</label>
                                    <input className="form-control filter-profession" list="datalistOptions2" id="exampleDataList2" placeholder="Tất cả địa điểm" onChange={handleAreaChange}></input>
                ...
                {/* <div className="d-flex search-job input-group ">
          <div className='search-content'>
            ...
            <div className="table-info row row-cols-2 row-cols-lg-3">
              ...
              <div className="form-outline mb-4">
                <label >Form of work</label>
                <input className="form-control" list="formlist" id="formdatalist" placeholder="Hình thức làm việc"></input>
                <datalist id="formlist">
                  <option value="Toàn thời gian" />
                  <option value="Bán thời gian" />
                  <option value="Thực tập" />
              ...
              <div className="form-outline mb-4">
                <label >Rank</label>
                <input className="form-control" list="ranklist" id="rankdatalist" placeholder="Cấp bậc"></input>
                <datalist id="ranklist">
                  <option value="Nhân viên" />
                  <option value="Trưởng nhóm" />
                  <option value="Trưởng / Phó phòng" />
              ...
              <div className="box-content col-md-5">
                <div className="box-create-cv mb-16">
                  <div className="box-item">
                    ...
                    <a href={(currentuser) ? "/createcv" : "/employeelogin"} className="btn btn-success btn-search-job" ><i className="fa-solid fa-plus"></i> Tạo CV ngay</a>
                  </div>
              ...
              <div className=" box-content col-md-5">
                <div className="box-create-cv">
                  <div className="box-item">
                    ...
                    <a href={(currentuser) ? "/uploadcv/" + currentuser.id : "/employeelogin"} className="btn btn-success btn-search-job" > <i className="fa-solid fa-upload"></i> Upload CV ngay</a>
                  </div>
