...
const RecommendJobs = (props) => {
    ...
    const getRequestParams = (searchTitle, companyName, page, pageSize) => {
        let params = {};
    ...
    const retrieveJobs = () => {
        const params = getRequestParams(props.title, props.name, page, pageSize);
        ...
        <div>
            <div className='body-job-content'>
                <div className="list-job col-md" id='list-job'>
                    <h1 style={{ marginBottom: "3%" }}>Company's Jobs</h1>
